        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav gap-2 ms-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link link-primary <?php if($currentPage=='articles') echo 'active'; ?>" href="/articles">Articles</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link link-primary <?php if($currentPage== 'about') echo 'active'; ?>" href="/about">About</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link link-primary <?php if($currentPage=='contact') echo 'active'; ?>" href="/contact">Contact</a>
                    </li>
                </ul>
            </div>
        </div>
